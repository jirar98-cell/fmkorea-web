...
[분류 원칙]
- 제목의 표면 단어가 아니라 내용·맥락으로 분류하라. 키워드가 없어도 의미로 판단.
  예) "물범 갖고싶내"→동물 / "월급 들어오자마자 증발"→직장 / "남친이 갑자기 연락두절"→연애 / "조선시대엔 이게 흔했다"→역사
- 24개 중 가장 잘 맞는 1~2개를 골라라. 애매해도 가장 가까운 구체 태그를 우선.
- "잡학"은 나머지 23개 어디에도 정말 못 넣을 때만 쓰는 최후수단이다.
  인물·동물·직장·연애·유머·공감 같은 구체 태그가 조금이라도 맞으면 그걸 써라.
  제목만으론 의미·맥락이 전혀 안 잡힐 때만 잡학.
...
- 강아지: 강아지 이야기
- 야생: 야생동물·자연·생태계
- 잡학: 어느 구체 태그에도 안 맞는 잡다한 지식 (최후수단 — 다른 태그가 조금이라도 맞으면 금지)
- 역사: 역사적 사건·인물
- 과학: 과학·의학·신체·기술
...
- 표면 단어가 아닌 내용으로 분류. "잡학"은 최후수단 — 구체 태그 우선.
- s: 0~10 정수
JSON 배열만. 설명 금지."""
